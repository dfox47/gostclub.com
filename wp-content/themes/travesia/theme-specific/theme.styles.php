...
if (!function_exists('travesia_customizer_get_css')) {

	function travesia_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = travesia_customizer_add_theme_fonts($fonts);
...
.travesia_tabs .travesia_tabs_titles li a {
...
.top_panel .slider_engine_revo .slide_title, table th, .widget_product_tag_cloud a, .widget_tag_cloud a, .sc_layouts_title_breadcrumbs, .trx_addons_popup .trx_addons_tabs_titles li.trx_addons_tabs_title, .trx_addons_popup_form_name, .trx_addons_popup_form_field_submit .submit_button, .sc_skills_pie.sc_skills_compact_off .sc_skills_item_title, .post_item_single .post_content .post_tags a, .nav-links-single .nav-links .nav-previous .post_next, .nav-links-single .nav-links .nav-next .post_prev, .comments_list_wrap .comment_posted, .comments_list_wrap .comment_reply{
	{$fonts['h1_font-family']}
}
...
.trx_addons_audio_player .audio_author, .single.single-post .sc_layouts_title .post_meta_item.post_categories a {
	{$fonts['h1_font-family']}
}
.search_wrap .search_results .post_meta_item,
.search_wrap .search_results .post_counters_item, .post-date, .rss-date .post_date, .post_meta_item, .post_counters_item{
	{$fonts['p_font-family']}
}
...
CSS;
			$rez = apply_filters('travesia_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(travesia_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = travesia_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = travesia_customizer_add_theme_colors($colors);
...
/* Tour Master */
.trx-booking-tour-form-field input[type="text"]:focus,
.trx-booking-tour-form-field input[type="email"]:focus,
.trx-booking-tour-form-field input[type="password"]:focus,
.trx-booking-tour-form-field textarea:focus,
.trx-booking-tour-form-field select:focus,
.trx-booking-tour-form-field.trx-booking-tour-with-border input[type="text"]:focus,
.trx-booking-tour-form-field.trx-booking-tour-with-border input[type="email"]:focus,
.trx-booking-tour-form-field.trx-booking-tour-with-border input[type="password"]:focus,
.trx-booking-tour-form-field.trx-booking-tour-with-border textarea:focus,
.trx-booking-tour-form-field.trx-booking-tour-with-border select:focus,
/* BB Press */
...
.footer_wrap input[type="search"]:focus{
...
.tourmaster-tour-booking-bar-outer .select_container:before{
	background: transparent !important;
}

.tourmaster-container .select_container:before{
	background: transparent !important;
}
...
.sc_button.sc_button_bordered.trx_addons_popup_link{
...
.sc_button_default.color_style_link2, .comments_wrap .form-submit input[type="submit"],
...
/* Tour Master */
.trx-booking-tour-tour-search-wrap input.trx-booking-tour-tour-search-submit[type="submit"]:hover,
/* Tribe Events */
...
.sc_layouts_row_type_compact .sc_layouts_item_details_line1:hover{
    color: {$colors['alter_hover']}!important;
}
...
.search_style_fullscreen.search_opened .search_form_wrap {
	background-color: {$colors['alter_bg_hover_09']};
}
...
.search_style_fullscreen.search_opened .search_field::-webkit-input-placeholder {color:{$colors['inverse_link']}; opacity: 1;}
.search_style_fullscreen.search_opened .search_field::-moz-placeholder          {color:{$colors['inverse_link']}; opacity: 1;}/* Firefox 19+ */
.search_style_fullscreen.search_opened .search_field:-moz-placeholder           {color:{$colors['inverse_link']}; opacity: 1;}/* Firefox 18- */
.search_style_fullscreen.search_opened .search_field:-ms-input-placeholder      {color:{$colors['inverse_link']}; opacity: 1;}
...
.single.single-post .sc_layouts_title .post_date a:hover,
.single.single-post .sc_layouts_title .post_date:hover:after,
.single.single-post .sc_layouts_title a.post_meta_item:hover,
.single.single-post .sc_layouts_title a.post_meta_item:hover:before,
.single.single-post .sc_layouts_title .post_meta_item a:hover,
.single.single-post .sc_layouts_title .post_meta_item a:hover:before,
.single.single-post .sc_layouts_title .post_meta_item.post_categories a:hover,
.single.single-post .sc_layouts_title .post_info .post_info_item a:hover,
.single.single-post .sc_layouts_title .post_info_counters .post_counters_item:hover {
	color: {$colors['text_link']};
}
...
.travesia_tabs .travesia_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_hover']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.travesia_tabs .travesia_tabs_titles li.ui-state-active a {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link2']};
}
...
.single.single-post .sc_layouts_title .post_meta_item.post_categories a{
	background-color: {$colors['text_link2']};
}
.single.single-post .sc_layouts_title .post_meta_item.post_categories a:hover{
	background-color: {$colors['text_link']};
...
.nav-links-single .nav-links .nav-previous .post_next, .nav-links-single .nav-links .nav-next .post_prev{
	color: {$colors['text_link2']};
}
...
footer.scheme_self .widget ul > li a{
	color: {$colors['text']};
}
footer.scheme_self .widget ul > li a:hover{
	color: {$colors['inverse_link']};
}
footer.scheme_self .widget ul > li:before{
	color: {$colors['text']};
}
footer.scheme_self .widget ul > li:before a:hover{
	color: {$colors['inverse_link']};
}
...
.trx_addons_popup_form_name{
	color: {$colors['text_dark']};
}
.trx_addons_popup_form_field_remember_forgot a{
	color: {$colors['alter_hover']};
}
.trx_addons_popup_form_field_remember_forgot a:hover{
	color: {$colors['alter_link']};
}
...
CSS;
					...
					$rez = apply_filters('travesia_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'travesia_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>