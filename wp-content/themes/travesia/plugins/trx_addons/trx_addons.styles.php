...
if (!function_exists('travesia_trx_addons_get_css')) {
	add_filter('travesia_filter_get_css', 'travesia_trx_addons_get_css', 10, 4);
	function travesia_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.sc_services_iconed .sc_services_item_title, .sc_testimonials_item_author_subtitle, .sc_action_item_description, .sc_recent_news .post_item .post_meta, .sc_content .sc_item_title + .sc_item_descr.sc_content_descr{
	{$fonts['p_font-family']}
}
...
.sc_slider_controller_info, .trx_addons_dropcap, .sc_price_item_description,
.sc_price_item_details, .sc_testimonials_item_content, .sc_testimonials_item_author_title, .sc_recent_news .post_item .post_featured .post_info .post_categories, .sc_blogger.sc_blogger_default .post_featured .post_info a {
	{$fonts['h5_font-family']}
}
.sc_blogger_announce .post_featured .post_info .post_exerpt, .sc_blogger_classic .post_featured .post_info .post_exerpt, .sc_blogger_announce .post_item.post_size_small.button_article .desc_button_bloger_announce{
...
.sc_testimonials_item_content:before, .sc_item_title + .sc_item_descr {
	{$fonts['info_font-family']}
}
.sc_button,
.sc_button_simple,
...
.sc_recent_news .post_item .post_meta .post_date a, .sc_recent_news .post_item .post_meta .post_comment{
...
.sc_action.sc_action_simple .sc_action_item_link.sc_button.sc_button_bordered:hover{
	color:{$colors['inverse_link']}!important;
	border-color:{$colors['inverse_link']}!important;
}
.sc_action_item_subtitle + .sc_action_item_description, .sc_action_item_title + .sc_action_item_description, 
...
.sc_blogger.sc_blogger_default .post_featured .post_info a{
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link2']};
}
.sc_blogger_announce .post_featured .post_info a{
	color: {$colors['inverse_link']};
}

.sc_blogger_announce .post_featured .post_info a:hover{
	color: {$colors['text_hover2']};
}
.sc_blogger_announce .post_featured .post_info .post_exerpt{
	color: {$colors['inverse_link']};
}

.sc_blogger_announce .post_item.post_size_small.button_article{
	background-color: {$colors['text_link2']};
}
.sc_blogger_announce .post_item.post_size_small.button_article a, .sc_blogger_announce .post_item.post_size_small.button_article .desc_button_bloger_announce{
	color: {$colors['inverse_link']};
}
.sc_blogger_announce .post_item.post_size_small.button_article a:hover{
	color: {$colors['text_dark']};
}
.sc_blogger_announce .post_size_small .post_featured .post_info .post_exerpt:after{
	color: {$colors['inverse_link']};
}
.sc_blogger_classic .post_featured .post_info, .sc_blogger_classic .post_featured .post_info h3 a{
	color: {$colors['inverse_link']};
}
.sc_blogger_classic .post_featured .post_info h3 a:hover{
	color: {$colors['text_link2']};
}
