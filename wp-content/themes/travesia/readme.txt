...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About Travesia'.
Please install and activate it before starting to use the theme Travesia.
...
Theme documentation is available on http://travesia.axiomthemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Travesia is Fontello.
