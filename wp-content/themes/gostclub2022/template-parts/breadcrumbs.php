...
<?php function get_breadcrumbs() { ?>
	<div class="wrap">
		<div class="breadcrumbs">
			<?php echo '<li class="breadcrumbs__item"><a class="breadcrumbs__home" href="' . home_url() . '" rel="nofollow">Home</a></li>';
			...
			elseif (is_page()) { ?>
				<li class="breadcrumbs__item"><span><?php echo the_title(); ?></span></li>
			<?php }
			elseif (is_search()) {
