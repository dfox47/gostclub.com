	...
	<div class="header_wrap">
		<div class="wrap">
			<div class="header">
				...
				<a class="header_logo" href="<?= $logoLink; ?>">
					<span class="header_logo__name">GOST</span>
					<span class="header_logo__country">Balkans</span>
					<span class="header_logo__iso">Official e-journal ISSN 2367-8402</span>
				</a>
...
if (is_front_page()) {
	...
	<div class="hero_slider">
		<div class="js-owl-carousel-auto owl-carousel">
			<a class="hero_slider__item js-img-bg" href="//nazarov-sofia.com" target="_blank" data-src="<?= $heroImg; ?>/10.jpg"></a>
